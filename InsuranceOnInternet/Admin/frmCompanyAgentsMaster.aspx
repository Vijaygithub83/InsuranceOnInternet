<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmCompanyAgentsMaster.aspx.cs" Inherits="Admin_frmCompanyAgentsMaster" Title="Untitled Page" %>
    ...
    <div>
        <center>
            ...
            <asp:Label ID="lblHeading" BackColor="Window" ForeColor="#5D7B9D" 
                runat="server" Text="Company Agents Master"
            ...
            <asp:UpdatePanel ID="panel1" runat="server">
              <%-- <Triggers>               
               ...
               <asp:AsyncPostBackTrigger ControlID="btncancel" EventName="Click" />
                ...
                <ContentTemplate>
                    <table style="border: thin solid #5D7B9D; background-color:#5D7B9D; width: 400px; ">
                        <tr>
                            <td  colspan="2">
                    ...
                    <table style="border: thin solid #5D7B9D; background-color: Window;  width: 400px;">
                        ...
                        <td >
                            <asp:DropDownList ID="ddlCompanyId" runat="server" 
                                Height="44px" 
                                 Width="120px" onselectedindexchanged="ddlCompanyId_SelectedIndexChanged">
                            </asp:DropDownList>
                            </td>
                        <td>
                        <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="*" ControlToValidate="ddlCompanyId"></asp:RequiredFieldValidator>
                        </td>
                        </tr>
                        <tr>
                        <td colspan="3"></td>
                        ...
                        <td >AgentName</td>
                        <td  align="center">
                            <asp:DropDownList ID="ddlAgent" runat="server"  Height="44px" Width="120px" OnSelectedIndexChanged="ddlAgent_SelectedIndexChanged">
                            </asp:DropDownList>
                            </td>
                        <td>
                        </td>
                     ...
                     <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                    <td colspan="3">
                        <asp:GridView AutoGenerateColumns="False" ID="grdAgents" runat="server" 
                            Width="300px" CellPadding="4" ForeColor="#333333" GridLines="None" 
                            AllowPaging="True" PageSize="5" onpageindexchanging="grdAgents_PageIndexChanging" 
                            >
