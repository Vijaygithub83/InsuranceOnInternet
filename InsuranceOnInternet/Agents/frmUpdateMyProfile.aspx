<%@ Page Language="C#" MasterPageFile="~/Agents/AgentsMasterPage.master" AutoEventWireup="true" CodeFile="frmUpdateMyProfile.aspx.cs" Inherits="Agents_frmUpdateMyProfile" Title="Untitled Page" %>
                ...
                <ContentTemplate>
                    ...
                    <table style="border: thin solid #5D7B9D; background-color: Window;  width: 670px;">
                        ...
                        <td colspan="6" align="center" style=" background-color:#5D7B9D" >
                            <b style="color: #FFFFFF">Update My Profile </b>
                        </td>
                        </tr>
