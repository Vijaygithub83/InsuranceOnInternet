<%@ Page Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="frmAgentRegistration.aspx.cs" Inherits="frmAgentRegistration" Title="Untitled Page" %>
...
<%--               <asp:AsyncPostBackTrigger ControlID="RadioButtonList1" EventName="SelectedIndexChanged" />
               <asp:AsyncPostBackTrigger ControlID="ddlCustId" EventName="SelectedIndexChanged" />
--%>               <asp:AsyncPostBackTrigger ControlID="btnSubmit" EventName="Click" />
          ...
          <asp:AsyncPostBackTrigger ControlID="btnCloseGrid" EventName="Click" />--%>
               <asp:AsyncPostBackTrigger ControlID="btnCancel" EventName="Click" />
                ...
                <ContentTemplate>
                    <%--<table style="border: thin solid #7CCFBE; background-color:#7CCFBE; width:690px;">
                        <tr>
                            <td  colspan="2">
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="ddlCustId" Enabled="False" runat="server" Height="44px"
                                    Width="120px" OnSelectedIndexChanged="ddlCustId_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>--%>
                    ...
                    <table style="border: thin solid #5D7B9D; background-color: Window;  width: 670px;">
                        ...
                        <%--<td rowspan="2" class="style1">Customer Address</td>
                        <td rowspan="2"><asp:TextBox ID="txtAddress" TextMode="MultiLine" runat="server" 
